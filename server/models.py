...
class Activity(db.Model, SerializerMixin):
    ...
    campers = association_proxy(
        "signups", "camper", creator=lambda camper_obj: Signup(camper=camper_obj)
    )

    # Add serialization rules
    serialize_rules = ("-signups.activity", "-campers.actvities")
...
class Camper(db.Model, SerializerMixin):
    ...
    # Add serialization rules
    serialize_rules = ("-signups.camper", "-activites.campers")
